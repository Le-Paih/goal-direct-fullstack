...
const sendErrorDev = (err, req, res) => {
  // A. API
  // originalUrl is the entire URL but not with the host, so looks like the route
  ...
  return res.status(err.statusCode).render('error', {
    ...
    msg: err.message, // in development it doesn't matter if the details of the error are leaked as no one is going to see it
  });
};
